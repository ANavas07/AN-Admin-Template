...
export function AddColumnButton({ onClick }: Props) {
    return (
        <button
            type="button"
            onClick={onClick}
            className="flex h-11 w-72 shrink-0 items-center justify-center gap-2 rounded-2xl border border-dashed border-line text-sm font-medium text-fg-muted transition-colors hover:border-brand hover:text-brand"
        >
