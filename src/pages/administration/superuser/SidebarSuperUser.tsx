...
export type NavItem = {
    id: string
    label: string
    /** An icon element, or any text such as an emoji (kept for compatibility) */
    icon: ReactNode
}
...
export default function SidebarSuperUser({
    ...
    return (
        <>
            ...
            >
                {/* Header */}
                <div className="flex items-center justify-between gap-2 p-4 border-b border-line shrink-0">
                            ...
                            className={`
                                ...
                                ${
                                    activeItem === item.id
                                        ...
                                        : 'text-fg hover:bg-canvas-subtle hover:text-brand'
                                }
                            `}
                        >
